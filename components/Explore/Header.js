    ...
    <>
      ...
      >
        ...
        <div className="img-container">
          <img src={"/people.jpeg"} id="myVideo" />
        </div>
        ...
        <div className="flex-col items-center content justify-center border">
          ...
          >
            <div className="pl-12">
              <h1 className="text-6xl text-center font-serif font-light text-white">
                Learn{" "}
                <span className="text-6 xl text-blue-700 italic">Develop</span>{" "}
                Earn
              </h1>
