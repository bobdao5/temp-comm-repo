...
const LoginPage = () => {
  ...
  return (
    <div className="video-container flex justify-between text-black">
      ...
      />
      <div
        className="w-[100vw] h-[60vh] mt-32 absolute"
        style={{
          zIndex: -1,
          background: "rgba(1, 1, 1, 1)",
        }}
      ></div>
      <div className="min-h-[calc(70vh)] lg:flex-2/3 w-full lg:w-1/2 relative z-10 rounded-xl  flex justify-between ml-[500px] mt-8">
