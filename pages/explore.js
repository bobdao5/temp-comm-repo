...
const GigsListing = () => {
  ...
  return (
    <div>
      ...
      {/* <div
        className="flex-col pt-20 transition ease-in-out delay-80 w-full bg-cover absolute z-10"
        style={{
      ...
      />
      <div className="flex gap-x-5 mb-12 absolute z-10 mt-16">
        {searchedGigs.length == 0 ? (
          <div className="mt-10 w-full mr-5 flex flex-col">
            <p className="text-white font-bold text-5xl pl-20 my-2">Commune</p>
            <p className="text-gray-500 font-light text-xl pl-20 my-2 mb-5">
              Explore communities and events
            </p>
            <Deck />
          </div>
        ) : (
