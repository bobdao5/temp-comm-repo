...
const { contractAddresses, Gig_abi } = require("../constants");
...
const CreateFreelancerPage = () => {
  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center min-h-[calc(100vh-120px)]  bg-gradient-to-br from-blue-900 via-gray-800 to-gray-900 h-screen absolute z-10 ml-[200px]">
        <ErrorBox
                    ...
                    /> */}
                      <p className="mt-2 text-gray-600 text-xs">
                        <ul className="list-disc ml-2">
                          ...
                          <li>
                            Select the elements you want to include in each
                            offer
                          </li>
